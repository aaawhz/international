...
(function () {
    ...
    RichTextBox.prototype = {
        ...
        getHtml : function() {
            ...
            html.push("<div id=\"editor_tool_bar_up" + this.id + "\" class=\"eidt-bar-li\"> <a href=\"javascript:fGoto();\" onclick=\"RTB_items['" + this.id + "'].doMenu('Bold');\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.jiacu+"\">");
            html.push(top.Lang.Mail.Write.xuanzhongjiashang);//<!-- 选 中 加上  edit-btn-on -->
            html.push("<span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-b\">");
            html.push(top.Lang.Mail.Write.jiacu);//加粗
            html.push("</b> </span> </a> <span class=\"line\"></span> <a class=\"edit-btn editor-btn-select\" href=\"javascript:fGoto();\" onclick=\"RTB_items['" + this.id + "'].showMenu('fontFamily" + this.id + "');\" title=\""+top.Lang.Mail.Write.ziti+"\"> <span class=\"edit-btn-rc\">");
            html.push(top.Lang.Mail.Write.ziti);//字体
            html.push("</span> </a> <a class=\"edit-btn editor-btn-select\" href=\"javascript:fGoto();\" onclick=\"RTB_items['" + this.id + "'].showMenu('fontSize" + this.id + "');\" title=\""+top.Lang.Mail.Write.zihao+"\">");
            html.push("<span class=\"edit-btn-rc\">");
            html.push(top.Lang.Mail.Write.zihao);//字号
            html.push("</span> </a> <span class=\"line\"></span> <a href=\"javascript:fGoto();\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.zitiyanse+"\" onclick=\"RTB_items['" + this.id + "'].showMenu('fontColorSelect" + this.id + "');\"> <span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-color\">");
            html.push(top.Lang.Mail.Write.zitiyanse);//字体颜色
            html.push("</b> </span> </a> <a href=\"javascript:fGoto();\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.beijingse+"\" onclick=\"RTB_items['" + this.id + "'].showMenu('bgColorSelect" + this.id + "');\"> <span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-fb\">");
            html.push(top.Lang.Mail.Write.beijingse);//背景色
            ...
            html.push(top.Lang.Mail.Write.xieti);//斜体
            html.push("</b> </span> </a> <a href=\"javascript:fGoto();\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.xiahuaxian+"\" onclick=\"RTB_items['" + this.id + "'].doMenu('Underline');\"> <span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-ud\">");
            html.push(top.Lang.Mail.Write.xiahuaxian);//下划线
            ...
            //html.push("有序列表");
            html.push("</b> </span> </a> <span class=\"line\"></span> <a href=\"javascript:fGoto();\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.zuoduiqi+"\" onclick=\"RTB_items['" + this.id + "'].doMenu('Justifyleft');\"> <span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-alil\">");
            html.push(top.Lang.Mail.Write.zuoduiqi);//左对齐
            html.push("</b> </span> </a> <a href=\"javascript:fGoto();\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.jizhongduiqi+"\" onclick=\"RTB_items['" + this.id + "'].doMenu('Justifycenter');\"> <span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-aliz\">");
            html.push(top.Lang.Mail.Write.jizhongduiqi);//居中对齐
            html.push("</b> </span> </a> <a href=\"javascript:fGoto();\" class=\"edit-btn\" title=\""+top.Lang.Mail.Write.youduiqi+"\" onclick=\"RTB_items['" + this.id + "'].doMenu('Justifyright');\"> <span class=\"edit-btn-rc\"> <b class=\"ico-edit ico-edit-alir\">");
            html.push(top.Lang.Mail.Write.youduiqi);//右对齐
            ...
            html.push("</div>");
            html.push(top.Lang.Mail.Write.bianjiqizicaidan);//<!----编辑器子菜单----->
            ...
            html.push("<li><a style=\"font-family: '"+top.Lang.Mail.Write.songti+"';\" href=\"javascript:fGoto();\" onclick=\"jQuery('#fontFamily" + this.id + " a').removeClass('current'); jQuery(this).addClass('current');RTB_items['" + this.id + "'].doMenu('fontname','"+top.Lang.Mail.Write.songti+"');\"><i></i>"+top.Lang.Mail.Write.songti+"</a></li>");//'].doMenu('fontname','宋体');\"><i></i>宋体</a></li>
            html.push("<li><a style=\"font-family: '"+top.Lang.Mail.Write.heiti+"';\" href=\"javascript:fGoto();\" onclick=\"jQuery('#fontFamily" + this.id + " a').removeClass('current'); jQuery(this).addClass('current');RTB_items['" + this.id + "'].doMenu('fontname','"+top.Lang.Mail.Write.heiti+"');\"><i></i>"+top.Lang.Mail.Write.heiti+"</a></li>");//'].doMenu('fontname','黑体');\"><i></i>黑体</a></li>
            html.push("<li><a style=\"font-family: '"+top.Lang.Mail.Write.kaiti+"';\" href=\"javascript:fGoto();\" onclick=\"jQuery('#fontFamily" + this.id + " a').removeClass('current'); jQuery(this).addClass('current');RTB_items['" + this.id + "'].doMenu('fontname','"+top.Lang.Mail.Write.kaiti+"');\"><i></i>"+top.Lang.Mail.Write.kaiti+"</a></li>");//'].doMenu('fontname','楷体');\"><i></i>楷体</a></li>
            html.push("<li><a style=\"font-family: '"+top.Lang.Mail.Write.lishu+"';\" href=\"javascript:fGoto();\" onclick=\"jQuery('#fontFamily" + this.id + " a').removeClass('current'); jQuery(this).addClass('current');RTB_items['" + this.id + "'].doMenu('fontname','"+top.Lang.Mail.Write.lishu+"');\"><i></i>"+top.Lang.Mail.Write.lishu+"</a></li>");//'].doMenu('fontname','隶书');\"><i></i>隶书</a></li>
            html.push("<li><a style=\"font-family: '"+top.Lang.Mail.Write.youyuan+"';\" href=\"javascript:fGoto();\" onclick=\"jQuery('#fontFamily" + this.id + " a').removeClass('current'); jQuery(this).addClass('current');RTB_items['" + this.id + "'].doMenu('fontname','"+top.Lang.Mail.Write.youyuan+"');\"><i></i>"+top.Lang.Mail.Write.youyuan+"</a></li>");//'].doMenu('fontname','幼圆');\"><i></i>幼圆</a></li>
            ...
            html.push("<span>"+top.Lang.Mail.Write.texiao+"</span>");//<span>特小</span>
            html.push("</a></li>");
            ...
            html.push("<span>"+top.Lang.Mail.Write.zhong+"</span>");//<span>中</span>
            html.push("</a></li>");
            ...
            html.push("<span>"+top.Lang.Mail.Write.da+"</span>");//<span>大</span>
            html.push("</a></li>");
            ...
            html.push("<span>"+top.Lang.Mail.Write.jiaoda+"</span>");//<span>较大</span>
            html.push("</a></li>");
            ...
            html.push("<span>"+top.Lang.Mail.Write.henda+"</span>");//<span>很大</span>
            html.push("</a></li>");
            html.push("</ul>");
            html.push("</div>");
            ...
            html.push(top.Lang.Mail.Write.bianjiqizicaidanjieshu);//<!----编辑器子菜单结束----->
