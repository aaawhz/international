...
Tips_Message.prototype.show=function()
{
   ...
   var str ="<DIV id ='tip' style='border:solid 1px #000000;overflow:hidden;display:none  Z-INDEX: 99999;width: "+width+"px;height:0px;  POSITION: absolute;right: 0px;bottom: 0px; '>";
       ...
       str +="<SPAN title='"+top.Lang.Mail.Write.guanbi+"' style='FONT-WEIGHT: bold; FONT-SIZE: 20px; CURSOR: hand; COLOR: red; MARGIN-RIGHT: 4px' id='btSysClose' >×</SPAN></TD>";//<SPAN title=关闭 style='FONT-WEIGHT: bold; FONT-SIZE: 20px; CURSOR: hand; COLOR: red; MARGIN-RIGHT: 4px' id='btSysClose' >×</SPAN></TD>
       str +="</TR>";
       str +="<tr><td colspan='3'>"
       str +=this.innerHTML;
       str +="</td></tr></table>"
