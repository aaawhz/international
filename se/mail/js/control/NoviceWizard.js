    ...
    nextStep: function (step) {
        ...
        if (step == 5) {
            var ao = {
                ...
                dragStyle:1,
                title:top.Lang.Mail.Write.wenxintishi,//温馨提示
                text:"<div style='color: rgb(188, 188, 188);padding: 10px 20px 0;'>"+top.Lang.Mail.Write.yongyumimazhaohuizhongzhimima+"</div><div style='padding: 10px 20px;'>"+top.Lang.Mail.Write.wlndzhaqjysqtGHxjkdsjhszmbwt+"</div>",//<div style='color: rgb(188, 188, 188);padding: 10px 20px 0;'>用于密码找回、重置密码</div><div style='padding: 10px 20px;'>为了您的账号安全，建议您绑定手机或设置密保问题</div>
                scoll:"auto",
                buttons:[{
                    text:top.Lang.Mail.Write.bangdingshouji,//绑定手机
                    clickEvent:function(){top.location.href=parent.gMain.webPath+'/se/account/accountindex.do?sid='+parent.gMain.sid+'&mode=Mobile';},
                    isCancelBtn:false
                },{
                    text:top.Lang.Mail.Write.mibaowenti,//密保问题
