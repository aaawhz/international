	...
	var SensitiveMail = {
		...
		*/
		addTips: function () {
			...
			html += "此邮件夹中的邮件包含敏感信息，建议您阅读后立即删除";
			html += "<a href=\"javascript:;\" class=\"col_red ml_10\" onclick=\"SensitiveMail.closeTips();\">不再提醒</a>"
			html += "</p></div>";
		...
		*/
		getReadTips: function (data) {
			...
			if (data.flag && data.flag.signed === 1) {
				...
				html = "<div class=\"yellowTips\">此邮件夹中的邮件包含敏感词 <span class=\"col_red\">" + signedArr.join(",") + "</span></div>";
			}
			return html;
		}
	};
