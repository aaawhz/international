...
autoForward.check = function(){
    ...
    if (code == top.Lang.Mail.Write.qingdianjihuoquyanzhengmaEKUygslA || code == '') {//请点击获取验证码
        // codeerr.show();
...
autoForward.getHtml = function(ad){
    ...
    html.push('<li id="autoForwardCaptcha" class="clearfix p_relative">\
        <span class="left fl">'+top.Lang.Mail.Write.tupianyanzhengmaBFYYRovK+'</span>\
    <div class="p_relative" style=" margin-left:155px;">\
        ...
        <div class="tips-text">'+top.Lang.Mail.Write.tupianyanzhengmabunenweikongVWobXeeZ+'</div>\
        <div class="tipsLeft diamond"></div>\
        </div>\
        <p class="mt_10"><img class="captcha_img" id="unbind_imgShow" src="" /></p>\
        <a style="width:90px" href="javascript:void(0);" class="captcha_changeBtn">'+top.Lang.Mail.Write.kanbuqinghuanyizhangHKdRoKKW+'</a>\
    </p>\
    </p>\
    </div>\
    </li>');//
