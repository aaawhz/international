...
var Main = {    
    ...
    initAdvSearchHTML:function(){
        ...
        html.push(top.Lang.Mail.Write.deyoujian);//的邮件
        ...
        //<fmt:message key=\"mail.AdvSearch_AutoFill_Contain\"/>");
        html.push(top.Lang.Mail.Write.fajianren);//发件人：
        ...
        //<fmt:message key=\"mail.AdvSearch_AutoFill_Contain\"/>");
        html.push(top.Lang.Mail.Write.shoujianren);//收件人：
        html.push("<strong class=\"strOpt\"></strong>");
        html.push("</span></a></li>");
        ...
        //<fmt:message key=\"mail.AdvSearch_AutoFill_Contain\"/>");
        html.push(top.Lang.Mail.Write.zhuti);//主题：
        html.push("<strong class=\"strOpt\"></strong>");
        html.push("</span></a></li>");
        ...
        if(gMain.ftsFlag && GC.check("MAIL_MANAGER_FTR")){
            ...
            html.push(top.Lang.Mail.Write.quanwenjiansuo);//全文检索：
            //<fmt:message key=\"mail.AdvSearch_AutoFill_Contain\"/>");
...
/*
    ...
    OnAdvSearch: function(){
        ...
        var postData = {
            ...
            call : function(){
                gMain.ftsFlag = 1;
                Main.searchKeyStr = top.Lang.Mail.Write.youjiansousuo;//邮件搜索
