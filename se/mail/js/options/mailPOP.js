...
*/
	...
	html.push("<p class=\"\"style=\"color:#A2A2A2; padding-left:25px; margin-bottom:10px; font-size:15px;\">最多可添加5个代收邮箱</p>");
	...
	html.push("<td><input class=\"rm_cb\" type=\"checkbox\" checked=\"checked\" id=\"isAutoPOP\"> <label for=\"isAutoPOP\">自动收取</label></td>");
	html.push("</tr>");
...
*/
	...
	if (isEdit || mailPOP.dataList.length < 5) {
		...
		//提示邮件代收不能超过5个
		CC.alert(Lang.Mail.ConfigJs.pop_overflow+"5个");
	}
};
