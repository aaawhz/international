...
(function() {
	...
	/**
	 * 将对象转成xml文档对象 不添加节点属性
	 * @param {Object} v 要转换成xml文档的对象
	 */
	Util.obj2Dom2= function(v) {
		var cq = Util.getXMLDom();
		if (!cq) {
			return this.error("Create DOM error.");
		}
	 ...
	 * @return {String} 转换以后的字符串
	 */
	Util.obj2Str2 = function(v) {
		return this.dom2Str(this.obj2Dom2(v));
	};
	/**
	 * 将字符串转换成对象
	...
	Util.getFileClasssName = function(fileName)
	{
		  ...
		  if(fileName.lastIndexOf(".")>0)
		  {
			...
			if (extension == "7z") 
				...
				var icoClass = ["other", "tif", "txt", "psd", "rar", "zip", "xml", "html", "java", "fon","ico","jfif", "jpg", "jpe","gif", "png","jpeg", "bmp","tif", "tiff", "mpeg", "avi", "wmv", "mov", "mpg", "vob", "rmvb", "mp3", "wma", "wav", "asf", "mp4", "sis", "sisx", "cab", "doc", "docx", "pdf", "xls", "xlsx", "ppt", "pptx", "swf", "fla", "share", "folder", "mp3-hover", "upload", "i-hand", "flv", "folder-m", "folder-p", "exe", "css", "rm", "midi", "chm", "iso", "vsd", "no-load"];
