	...
	_getMenuObj: function () {
		...
		*/
		...
		var arrayMenuItem = {
			"span_1":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"查看未读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部标记为已读"},
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"创建分拣规则"}
			],
			"span_2":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"}
			...
			[
				...
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部标记为已读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"查看投递状态"}
			],
			"span_4":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部标记为已读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"清空已删除"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"查看删信状态"}
			],
			"span_5":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部标记为已读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"清空垃圾邮件"}
			],
			"span_6":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部标记为已读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"清空病毒邮件"}
			],
			"span_12":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
			...
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部审核通过"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部审核不通过"}
			],
			"span_-1":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"展开子目录","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				//{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"子目录标记为已读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"新建邮件夹"},
				//{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"创建分拣规则"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"邮件夹管理"}
			],
			"span_-2":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"展开","id": currentMenuName+"_"},
				{"liClass":"line", "isLiEmpty":"true"},
				//{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"全部标记为已读"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"新建标签"},
				//{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"创建分拣规则"},
				{"liClass":"", "isLiEmpty":"false", "aClass":"notuse", "aHref":"", "aShowValue":"标签管理"}
			],
			"span_-3":
			[
				{"liClass":"", "isLiEmpty":"false", "aClass":"", "aHref":"", "aShowValue":"打开","id": currentMenuName+"_"},
	...
	_changeInitCondition: function () {
		...
		if (subUl) {
			...
			if (jQuery("#span_-2_0")[0]) {
				jQuery("#span_-2_0")[0].innerHTML=(isshow ? "展开" : "折叠");
			}
		}
		...
		if (subUl) {
			...
			if (jQuery("#span_-1_0")[0]) {
				jQuery("#span_-1_0")[0].innerHTML=(isshow ? "展开子目录" : "折叠子目录");
			}
		}
